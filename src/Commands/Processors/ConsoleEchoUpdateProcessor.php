...
/**
 * Console long-polling demo processor behind tg:poll (--echo / --show / --once).
 * Instance-registered per command run — dependencies come from CLI options,
 * so ::build() has no meaningful context-only construction.
 */
final class ConsoleEchoUpdateProcessor implements TgTypeDTOProcessorContract
{
